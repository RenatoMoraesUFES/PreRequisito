...
O Colegiado do Curso de Engenharia de Produção Noturno do CT tem por costume dar prioridade na quebra de pré-requisito aos alunos finalistas que atendem os critérios para a Quebra de Pré-Requisito definidos abaixo. Lembrando que definição de finalista consta na [Resolução 58/2008 - CEPE](https://aluno.ufes.br/Documentos/resolucao_058_2008.pdf) da seguinte forma:
...
- O aluno deverá apresentar coeficiente acumulado de rendimento mínimo maior ou igual a cinco vírgula zero (5,0);
