...
O aluno deve comparecer à secretaria do Colegiado do Curso de Engenharia de Produção Noturno (CCEPN)), apresentando documento oficial de identificação e, `para cada disciplina a ter a quebra de Pré-Requisito analisada`, preencher e entregar [formulário](https://github.com/RenatoMoraesUFES/PreRequisito/blob/main/Formulario_Quebra_PreRequisito01.pdf) próprio de solicitação, acompanhado do histórico com Pré-Requisito(s) citado(s) no formulário destacados e comprovante de matrícula. Há um prazo previsto no calendário acadêmico vigente para fazer a solicitação. 
